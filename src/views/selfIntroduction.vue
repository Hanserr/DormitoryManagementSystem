...
<!--    视频背景-->
    ...
    <img src="../assets/img/selfIntroduction/bgvideo.webp" alt="bg" v-show="!isLoaded" class="selfIntroduction-bgPic">
<!--    中间内容部分-->
...
<!--        顶部头像区域-->
        <div class="selfIntroduction-top-avatar">
          <img src="../assets/img/selfIntroduction/avatar.webp" style="width: 80px;height: 80px;border-radius: 40px">
        </div>
        ...
        <div class="selfIntroduction-top-banner" ref="topBanner">
          <div><img src="../assets/img/selfIntroduction/bilibili-autumn-1.webp"></div>
          <div><img src="../assets/img/selfIntroduction/bilibili-autumn-2.webp"></div>
          <div><img src="../assets/img/selfIntroduction/bilibili-autumn-3.webp"></div>
          <div><img src="../assets/img/selfIntroduction/bilibili-autumn-4.webp"></div>
          <div><img src="../assets/img/selfIntroduction/bilibili-autumn-5.webp"></div>
          <div><img src="../assets/img/selfIntroduction/bilibili-autumn-6.webp"></div>
        </div>
      </div>
<!--      中间-->
...
export default {
  ...
  data(){
    return{
      //歌手详情列表
      favList:[
        {name:'The Chainsmokers',src:require('../assets/img/selfIntroduction/chainsmokers.webp'),intro:'美国电子音乐组合，由DJ兼歌手Andrew Taggart 以及DJ Alex Pall 组成'},
        {name:'ILLENIUM',src:require('../assets/img/selfIntroduction/illenium.webp'),intro: '来自美国丹佛的制作人ILLENIUM是目前最成功的跨界电子音乐艺人之一'},
        {name: 'Marshmello',src:require('../assets/img/selfIntroduction/marshmello.webp'),intro: '原名克里斯·康斯托克（Chris Comstock），美国DJ、电音制作人'},
        {name: 'Vicetone',src:require('../assets/img/selfIntroduction/vicetone.webp'),intro: '来自荷兰格罗宁根的DJ及电子音乐双人组，由成员Ruben Den Boer和Victor Pool组成'},
        {name: '泠鸢yousa',src:require('../assets/img/selfIntroduction/yousa.webp'),intro: '脱胎于三次元真人的虚拟艺人，中国本土原创最具人气的虚拟偶像之一。粉丝爱称冷鸟'},
        {name: '双笙',src:require('../assets/img/selfIntroduction/shuangsheng.webp'),intro: '双笙，本名陈元汐，中国内地古风女歌手'},
        {name: 'Martin Garrix',src:require('../assets/img/selfIntroduction/martin.webp'),intro: '荷兰DJ、音乐制作人，毕业于赫尔曼育学院'},
        {name: 'LinkinPark',src:require('../assets/img/selfIntroduction/linkinpark.webp'),intro: '林肯公园（Linkin Park），美国摇滚乐队，1996年成立于美国加利福尼亚州'},
        {name: 'ColdPlay',src:require('../assets/img/selfIntroduction/coldplay.webp'),intro: '酷玩乐队（Coldplay），英国摇滚乐队，1996年成立于伦敦'},
        {name: '鎖那',src:require('../assets/img/selfIntroduction/sana.webp'),intro: '活跃于niconico动画上的歌い手，2010年开始在niconico动画上投稿，主打治愈系声线'},
        {name: 'Taylor Swift',src:require('../assets/img/selfIntroduction/TW.webp'),intro: '泰勒·斯威夫特，出生于美国宾夕法尼亚州，美国女歌手、词曲作者、音乐制作人、演员'},
        {name: '司南',src:require('../assets/img/selfIntroduction/sinan.webp'),intro: '司南，中国内地女歌手'},
      ],
      poetry:[
        '惊起归鸿不成字，辞柯落叶最知秋。',
        '明夜扁舟去，和月载离愁。',
